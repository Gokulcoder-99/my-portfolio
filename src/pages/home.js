    ...
    <div className='home'>
        <div className='intro'>
            <div className='myself'>
               ...
               <a target='_blank'  rel='noreferrer' href='https://drive.google.com/file/d/1F8PW94gcuh1VzoXdhwoPZMMGBZd36FaN/view?usp=sharing' ><button className='btn'>Resume</button></a>
