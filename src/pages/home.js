    ...
    <div className='home'>
        <div className='intro'>
            <div className='myself'>
               ...
               <a target='_blank'  rel='noreferrer' href='https://drive.google.com/file/d/1O1xLpveXZE1J38a8npG3o6Qv9HoULql7/view?usp=sharingg' ><button className='btn'>Resume</button></a>
