...
import './project.css'
import nationalapi from '../assests/projectimage/nationalapi.png'
...
function Project() {
  ...
  return (
    ...
    <div className='project'>
      ...
      <div className='card'>
        <img className='projectimage' src={nationalapi} alt='nationlizeapi'/>
        <div className='detail'>
          <h2>Nationalize API(HACKATHON)</h2>
          <p>Implement the Nationalize API using async/await with fetch.<br/>
             All elements are created with DOM.</p>
          <div >
          <a target='_blank' rel='noreferrer' href='https://github.com/Gokulcoder-99/webcode-project'><button className='pbtn'>FrontEnd</button></a>
          <a target='_blank' rel='noreferrer' href="https://gokulcoder-99.github.io/webcode-project/"><button className='pbtn'>Live</button></a>
          </div>
        </div>
      </div>
    </div>
